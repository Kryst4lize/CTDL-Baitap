...
void timepoint() {
	...
	for (int j = 1; j <= 10; j++) {
		...
		cout << "Time to sort using heap sort "<<j<<" trial: "<< timepoint1.count() << endl;
		...
		cout << "Time to sort using quick sort "<<j<<" trial: " << timepoint2.count() << endl;
		...
		cout << "Time to sort using merge sort " << j << " trial: "<< timepoint3.count() << endl;
        cout << isSort(arrheap) << isSort(arrquick) << isSort(arrmerge) << endl << endl;
		//release memory
		delete[] arr;
		delete[] arrheap;
		delete[] arrquick;
